...
for imagem in key_imagem:
    imagem = str(imagem).split('emuladores/')[1].split('"/>')[0]
...
for i in range(len(links)):
    print('[Inserindo dados] EMULADOR --> Mysql')
    ...
    with conexao.cursor() as cursor:
        tabela = f"""INSERT INTO playstation_emuladores (titulo,descricao,content_id,imagem,cadastro,
