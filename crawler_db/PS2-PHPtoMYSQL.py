...
#variavies iniciais
dados = open('jogos/ps2.php', 'r', encoding="utf-8").read()
...
for i in range(len(links)):
    print('[Inserindo dados] Jogo PS2 --> Mysql')
    ...
    with conexao.cursor() as cursor:
        tabela = f"""INSERT INTO playstation_ps2 (titulo,descricao,content_id,imagem,cadastro,
