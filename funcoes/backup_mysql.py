...
Ao terminar o backup uma mensagem será exibida.""", QMessageBox.Ok)
    ...
    for dados_user in tabela_users:
        self.progressBar_backup_users.setValue(contador_users)
        contador_users += 1
        try:
    ...
    for dados_info in tabela_infos:
        self.progressBar_backup_infos.setValue(contador_info)
        contador_info += 1
        try:
    ...
    for dados_user in tabela_psp:
        self.progressBar_backup_psp.setValue(contador_psp)
        contador_psp += 1
        try:
    ...
    for dados_user in tabela_ps1:
        self.progressBar_backup_ps1.setValue(contador_ps1)
        contador_ps1 += 1
        try:
            titulo = dados_user['titulo']
            descricao = dados_user['descricao']
    ...
    for dados_user in tabela_ps2:
        self.progressBar_backup_ps2.setValue(contador_ps2)
        contador_ps2 += 1
        try:
            titulo = dados_user['titulo']
            descricao = dados_user['descricao']
    ...
    conexao.conexao_pymysql.commit()
    contador_emuladores = 0
    self.ui.progressBar_backup_emuladores.setMaximum(len(tabela_emuladores))
    for dados_user in tabela_emuladores:
        self.progressBar_backup_emuladores.setValue(contador_emuladores)
        contador_emuladores += 1
        try:
            titulo = dados_user['titulo']
            descricao = dados_user['descricao']
            content_id = dados_user['content_id']
    ...
    for dados_user in tabela_extras:
        self.progressBar_backup_extras.setValue(contador_extras)
        contador_extras += 1
        try:
            titulo = dados_user['titulo']
            descricao = dados_user['descricao']
    ...
    for dados_user in tabela_ps3:
        self.progressBar_backup_ps3.setValue(contador_ps3)
        contador_ps3 += 1
        try:
            titulo = dados_user['titulo']
            descricao = dados_user['descricao']
