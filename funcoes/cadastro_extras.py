...
def selecionarImagemextras(self):
    ...
    try:
        ...
        conexao.ftp.storbinary(f'STOR assets/images/extras/{self.nome_imagem_extras}', file)  # send the file
...
def updaterowextras(self):
    if self.ui.tabela_dados_db_extras.currentIndex().row() > -1:
        ...
        record.setValue("link", self.ui.input_descricao_extras.text())  # LINK
