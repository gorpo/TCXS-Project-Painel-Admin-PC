...
def selecionarImagemps1(self):
    ...
    try:
        ...
        conexao.ftp.storbinary(f'STOR store/assets/images/ps1/{self.nome_imagem_ps1}', file)  # send the file
        ...
        if str(visita_site) == '16384':  # numero do botao de confirmação do QMessageBox | negação = 65536
            webbrowser.open('https://tcxsproject.com.br/store/assets/images/ps1/', new=2)
    except:
        pass
