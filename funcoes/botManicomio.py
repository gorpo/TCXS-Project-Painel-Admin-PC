...
def ativaBot(self):
    if self.ui.bot_token_manicomio.text() == 'insira o token do bot' and self.ui.bot_canalid_manicomio.text() == 'insira id do canal do bot' and self.ui.bot_idpessoal_manicomio.text() == 'insira sua id do telegram':
        api = '1186597860:AAHZTQT--xYhNHhkO8SbxlSxrdwVnkvi38s'   #api crowley 1186597860:AAHZTQT--xYhNHhkO8SbxlSxrdwVnkvi38s  #api gorpobot 1096480409:AAH6LhyWjRBk4KUFxaDmb46Lr3CG3x0MpzA
        id_canal = '-1001215401730'
        id_usuario = '522510051'
